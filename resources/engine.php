...
function computeTfIdf(){
    $document1 = file_get_contents(__DIR__.'/CV2.md');
    $document2 = file_get_contents(__DIR__.'/JobPost.md');
    
    $documents = array($document1, $document2);
    
    $idf = calculateIDF($documents);
    // dd($idf);
    $tfidf1 = calculateTFIDF($document1, $idf);
    // dd($tfidf1);
    $tfidf2 = calculateTFIDF($document2, $idf);
    // dd($tfidf2);
